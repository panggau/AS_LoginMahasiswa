...
public class MainActivity extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        _loginBotton = (Button) findViewById(R.id.loginButton);
        _passwordEditText = (EditText) findViewById(R.id.passwordEditText);

        _loginBotton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view)
            {
                ...
                asyncHttpClient.get(_url, new AsyncHttpResponseHandler()
                {
                    ...
                    public void onSuccess(int statusCode, Header[] headers, byte[] responseBody)
                    {
                        ...
                        {
                            Toast.makeText(getApplicationContext(), "ID atau Password Salah! Mohon coba kembali", Toast.LENGTH_SHORT).show();
                            return;
                        }
